...
<head>
    ...
    <meta property="og:description"
        content="Tom Clancy's The Division 2 Interactive Map. Shows entire map including the 1.8 content and includes a Survival Map mode. Has a Gear Set Collection Tool. NEW: Now includes a Last Stand Map Mode.">
...
?>
    ...
    <script src="js/Leaflet/leaflet<? echo ($_SERVER['HTTP_HOST'] == " localhost" ? "-src" : "" ); ?>
    1.0 .3.js ">
    </script>
    ...
    <link rel="stylesheet" href="sass/style.css?v=<? echo filemtime('sass/style.css') ?>" />
</head>
...
<body>
    ...
    <div id="alert" style="display:none">
        ...
        <form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_blank">
            ...
            <input type="image" class="paypalBtn" src="https://www.paypalobjects.com/en_GB/i/btn/btn_donate_SM.gif"
...
<script src="script.js?v=<? echo filemtime('script.js') ?>"></script>
