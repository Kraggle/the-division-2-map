...
<div class="credits">
	<? if (@$tran) { ?>
		<span style="display:<? echo ($credit->by == "" ? "none" : "block");?>" class="lang credits">Translated by: <a class="lang credits name dnt" href="mailto:<? echo $credit->email ?>"><? echo $credit->by ?></a></span><div style="margin-bottom:10px;"></div>
	<? } ?>
	...
	<? if (@$seal) { ?>
		<span id="siteseal"><script async type="text/javascript" src="https://seal.godaddy.com/getSeal?sealID=tN6HXw9rg0bmRN4Xwkgq2UPHXMG6uYgrh1Q7wvv5v9DEAmrCgSpYXQt7m7xP"></script></span>
	<? } ?>
